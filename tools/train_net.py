...
from maskrcnn_benchmark.engine.trainer import do_train, do_da_train, do_mask_da_train, do_mask_da_train_1,do_mask_anti_da_train,do_mask_clip_da_train
...
from maskrcnn_benchmark.modeling.masking import Masking,Anti_Masking,Anti_Masking_IF,Masking_Objects
...
def train(cfg, local_rank, distributed):
    ...
    checkpointer = DetectronCheckpointer(
        cfg, model, optimizer, scheduler, output_dir, save_to_disk,None
    )
    if 'CLIP' in cfg.MODEL.BACKBONE.CONV_BODY:
        pass
    else:
    ...
    if cfg.MODEL.DOMAIN_ADAPTATION_ON:
        ...
        if cfg.MODEL.MIC_ON:
            ...
            if cfg.MODEL.CLIP_ON:
                do_mask_clip_da_train(
                    model,
                    model_teacher,
                    source_data_loader,
                    target_data_loader,
